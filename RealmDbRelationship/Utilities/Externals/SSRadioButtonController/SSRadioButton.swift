...
class SSRadioButton: UIButton {
    ...
    */
    ...
    fileprivate func initialize() {
        ...
        self.titleEdgeInsets = UIEdgeInsets(top: 0, left: (4*circleRadius + 4*circleLayer.lineWidth) + 8, bottom: 0, right: 0)
        self.toggleButon()
    }
    /**
...
//            fillCircleLayer.fillColor = circleColor.cgColor
            fillCircleLayer.fillColor = UIColor.blue.cgColor
        } else {
            fillCircleLayer.fillColor = UIColor.clear.cgColor
        }
    }
    ...
    override func layoutSubviews() {
        ...
        self.titleEdgeInsets = UIEdgeInsets(top: 0, left: (2*circleRadius + 4*circleLayer.lineWidth) + 8, bottom: 0, right: 0)
    }
